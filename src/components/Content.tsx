...
export default function Content() {
  ...
  const cardContentProps: CardContentProps[] = [
    {
      title: "Corsi di vela", image: corsiSrc, text:
    ...
    {
      title: "Regate", image: regateSrc, text: `La nostra esperienza nasce dai monotipi Solaris36 e Platu25
    ...
    ` },
    {
      title: "Navigazione assistita", image: assistitaSrc, text: `Ai principianti che vogliono godersi il piacere di 
